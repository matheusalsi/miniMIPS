...
usage -auto -elapse
set log file logs_Mar01-21:41:22/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Mar01-21:41:22/minimips_intermediate.v
} else {
...
write hier_compare dofile outputs_Mar01-21:41:22/hier_rtl2intermediate.lec.do \
...
run hier_compare outputs_Mar01-21:41:22/hier_rtl2intermediate.lec.do -dynamic_hierarchy
