...
usage -auto -elapse
set log file logs_Mar09-11:58:56/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Mar09-11:58:56/minimips_intermediate.v
} else {
...
write hier_compare dofile outputs_Mar09-11:58:56/hier_rtl2intermediate.lec.do \
...
run hier_compare outputs_Mar09-11:58:56/hier_rtl2intermediate.lec.do -dynamic_hierarchy
