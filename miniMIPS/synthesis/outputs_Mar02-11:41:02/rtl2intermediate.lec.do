...
usage -auto -elapse
set log file logs_Mar02-11:41:02/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Mar02-11:41:02/minimips_intermediate.v
} else {
...
write hier_compare dofile outputs_Mar02-11:41:02/hier_rtl2intermediate.lec.do \
...
run hier_compare outputs_Mar02-11:41:02/hier_rtl2intermediate.lec.do -dynamic_hierarchy
