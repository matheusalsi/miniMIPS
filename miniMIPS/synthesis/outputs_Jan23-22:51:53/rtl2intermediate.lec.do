...
usage -auto -elapse
set log file logs_Jan23-22:51:53/rtl2intermediate.lec.log -replace
tclmode
...
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Jan23-22:51:53/minimips_intermediate.v
} else {
...
write hier_compare dofile outputs_Jan23-22:51:53/hier_rtl2intermediate.lec.do \
...
run hier_compare outputs_Jan23-22:51:53/hier_rtl2intermediate.lec.do -dynamic_hierarchy
