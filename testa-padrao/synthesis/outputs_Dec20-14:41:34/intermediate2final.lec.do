...
usage -auto -elapse
set log file logs_Dec20-14:41:34/intermediate2final.lec.log -replace
tclmode
...
vpx read design -verilog -golden -lastmod -noelab \
	outputs_Dec20-14:41:34/busca_padrao_intermediate.v
} else {
...
elaborate design -golden -root busca_padrao

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	outputs_Dec20-14:41:34/busca_padrao_m.v
} else {
